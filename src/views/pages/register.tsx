...
class Register extends RegisterControll {
    render() {
        return (
            <div className="register" style={{ backgroundImage: "url(" + ImageBackgroundLogin + ")" }}>
                ...
                <div className="register-modal">
                    ...
                    <div className="register-modal-input-group">
                        ...
                        <div className="register-modal-input-group-confirm-password">
                            <InputTextLabel
                                ...
                                type={"password"}
                                showDropDown={false}
                                onChange={(event) => { this.setState({ confirmPassword: event.currentTarget.value }) }}
                            />
                        </div>
                    </div>
                    <div className="register-modal-forgot-passsword">
                        <ComponentRadioSquare title={"I’ve read and accepet Touba’s rules."} active={false} />
                    ...
                    <div className="register-modal-divider">
                        <div className="register-modal-divider-line">
