...
import { IconCalling, IconDanger, IconShop, ImageJuicer, ImageManFlying, ImageManWithBox, ImageTest } from "../../assets";
...
import { BannerCongratulations, BannerLetsStart, Calendar, CardOverall, CardProductGroupTitle, ChartDoughnut, ChartSale, ComponentBasicInformation, ComponentTextArea, ImageArrow, Location, ModalCompany, ProductCart, SelectComponent, SelectComponentDouble, SummaryDashboard, TableTransaction, TextIconVertical, TextIconVerticalDashboard } from "../components/components";
