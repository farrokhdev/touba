...
function SelectComponentDouble({
  items1,
  items2,
  title1,
  title2,
  ...
  return (
    <div className="select-component-double">
      <div
        className="select-component-double-section-one"
        onMouseLeave={handleCloseDropDown1}
      >
        <div className="select-component-double-section-one-title">
          <h6>{title1 ? title1 : "Sub-Category"}</h6>
        </div>
        <div
          className="select-component-double-section-one-input"
          onClick={handleShowDropDown1}
        >
        ...
        {dropdown1 === true ? (
          <div
            className="select-component-double-section-one-dropdown"
            onMouseLeave={handleCloseDropDown1}
          >
            {items1?.map((link) => (
              <div className="select-component-double-section-one-dropdown-links">
                <span
                  key={link.id}
      ...
      <div
        className="select-component-double-section-two"
        onMouseLeave={handleCloseDropDown2}
      >
        <div className="select-component-double-section-two-title">
          <h6>{title2?.length ? title2 : "Category"}</h6>
        </div>
        <div
          className="select-component-double-section-two-input"
          onClick={handleShowDropDown2}
        >
        ...
        {dropdown2 === true ? (
          <div
            className="select-component-double-section-two-dropdown"
            onMouseLeave={handleCloseDropDown2}
          >
            {items2?.map((link) => (
              <div className="select-component-double-section-two-dropdown-links">
                <span
                  key={link.id}
