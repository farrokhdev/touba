    ...
    <div className="button-select">
      {state === 1 ? (
        <>
          ...
          >
            <p className="text-active">{titleButton1}</p>
          </button>
          <button
            className="button-select-two-deactive"
            onClick={handleOnClickButtonTwo}
          >
            <p className="text-deactive">{titleButton2}</p>
          </button>
        </>
      ) : (
        <>
          <button
            ...
            onClick={handleOnClickButtonOne}
          >
            <p className="text-deactive">{titleButton1}</p>
          </button>
          <button
            className="button-select-two-active"
            onClick={handleOnClickButtonTwo}
          >
            <p className="text-active">{titleButton2}</p>
          </button>
        </>
      )}
    </div>
