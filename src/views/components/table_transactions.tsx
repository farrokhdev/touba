...
export function TableTransaction({
  ...
  return (
    <div className="table-transaction">
      <div className="table-transaction-title d-flex flex-row align-items-center justify-content-between">
        <h4>{title ? title : "Income Transactions"}</h4>
        {transactionBtn ? <button>All Transactions</button> : null}
      </div>
