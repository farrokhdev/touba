...
export function BottomNav() {
    ...
    const handleshowMinimalDropDown = useCallback((event: MouseEvent<HTMLElement>) => {
    ...
    return (
        <>
            ...
            <div className="bottom-nav-minimal">
                ...
                <div className="offcanvas offcanvas-start" id="offcanvasMinimal" aria-labelledby="offcanvasTopLabel">
                    ...
                    <div className="offcanvas-body">
                        ...
                        <Link to="/">MAP</Link>
                        <DropDown title={"CATEGORIES"} links={[]} onClick={handleshowMinimalDropDown} />
